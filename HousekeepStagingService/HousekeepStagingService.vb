...
Imports System.Text
Public Class HousekeepStagingService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        gobjEvent.WriteToEventLog("Service Start Banner:    *       HousekeepStagingService STARTING       *")
        gobjEvent.WriteToEventLog("Service Start Banner:    ************************************************")
...
Public Class Worker
    ...
    Public Sub StopWork()
        ...
        gobjEvent.WriteToEventLog("Service Stopping Banner: *       HousekeepStagingService STOPPED             *")
        gobjEvent.WriteToEventLog("Service Stopping Banner: ************************************************")
    ...
    Function StartProcess() As Boolean
        ...
        Try
            ...
            If My.Settings.HousekeepStagingTables Then
                ...
                ' Delete outcomes from staging table bookmaker_xml_nodes
                ' Mainly introduced because some rows fail "Data trunctaed"
                Dim HousekeepOutcomes As New HousekeepDatabaseClass()
                HousekeepOutcomes.DeleteStaleOutcomesStaging()
                HousekeepOutcomes = Nothing
